...
export async function runAction(promise, okMsg) {
  const r = await promise;
  if (r.ok) toast(okMsg + " — 대기열에 추가됨. Claude Code에서 'process'로 반영하세요.", "ok");
  else if (r.mode === "clipboard") toast("서버 미연결: 명령을 클립보드에 복사했습니다. Claude Code에 붙여넣어 실행하세요.", "warn");
